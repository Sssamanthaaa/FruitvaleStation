...
public class WarmSpringActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warm_spring);
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                JSONObject warmspringsActivity = etd.getJSONObject(3); //you need to change this for other stations
                                JSONArray estimate = warmspringsActivity.getJSONArray("estimate");
